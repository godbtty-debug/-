...
do
    ...
    _G._plrDropObj = SpectateBox:AddDropdown("SpectatePlayer", {
        Text = "选择玩家",
        Values = initItems,
    ...
    task.spawn(function()
        while true do
            ...
            if _G._plrDropObj and typeof(_G._plrDropObj.SetValues) == "function" then
                _G._plrDropObj:SetValues(newItems)
                if #newItems > 0 and currentSelection then
                    ...
                    if not found then
                        _G._plrDropObj:SetValue(newItems[1])
                        currentSelection = newItems[1]
                    else
                        _G._plrDropObj:SetValue(currentSelection)
                    end
...
do
    ...
    _G._digToggle = DigBox:AddToggle("DigEnable", {
        Text = "启用遁地",
        Default = false,
    ...
    _G._digToggle:AddKeyPicker("DigKey", {
        Default = "None",
        Mode = "Toggle",
        Text = "遁地快捷键",
        SyncToggleState = true
